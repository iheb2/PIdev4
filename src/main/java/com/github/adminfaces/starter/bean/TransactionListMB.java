...
import com.github.adminfaces.starter.service.TransactionService;
...
@Named
@ViewScoped
public class TransactionListMB implements Serializable {

    @Inject
    TransactionService carService;
    @Inject
...
List<Transaction> transactionsss;

    public List<Transaction> getTransactionsss() {
    	transactionsss=(List<Transaction>) rep.findAll();
    	return transactionsss;
}

public void setTransactionsss(List<Transaction> transactionsss) {
    ...
    public List<StateT> completeModel(String query) {
        List<StateT> result = (List<StateT>) carService.getModels(query);
        return result;
    }
