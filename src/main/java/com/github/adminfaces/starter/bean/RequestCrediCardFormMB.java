...
@Named
@ViewScoped
public class RequestCrediCardFormMB implements Serializable {

    @Inject
   RequestCreditCardService reqService;

    private Long id;
    private RequestCreditCard req;
    ...
    public RequestCreditCard getCar() {
        return req;
    }

    public void setCar(RequestCreditCard req) {
        this.req = req;
    }
