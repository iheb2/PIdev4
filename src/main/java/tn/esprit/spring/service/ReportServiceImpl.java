...
import tn.esprit.spring.repo.ReportRepository;
...
public class ReportServiceImpl implements IReportService{
	...
	@Override
	public List<Report> SearchReportByState(StateR state) {
		// TODO Auto-generated method stub
...
public long max_report(Date min,Date max){                           //nb max de rapport par un seul client
	...
	for(User i: list){
		...
		{if (r.getDateR().before(max)&&r.getDateR().after(min)){list2.add(r);}
