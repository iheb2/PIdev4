...
////////////coté client/////////////////////////////////
	...
	//pour le client uniquement (afficher le chat relié au client en ligne)
	public Chat retriveChatclient() {	
		return retriveChat(String.valueOf(s.getId()));
	}
...
//mettre a jour le nb de msg non lus par le client  et le retourner(sera utiiser lors de la creation du msg)
	@Override
	public long updateChatclient() {
		Chat c = retriveChat(String.valueOf(s.getId()));
